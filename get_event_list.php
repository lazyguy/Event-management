...
if (!$con) {
    ...
    } else if (strcmp($q, "#########getgroupevents##############") == 0) {
        $sql = "select * from event_master where event_year='$year' and isgroup = '1' order by event_name";
    } else {
    ...
    $rsd = mysql_query($sql);
    $result = array();
    if ((strcmp($q, "######getallstuff##########") != 0)  && (strcmp($q, "#########getgroupevents##############") != 0)) {
